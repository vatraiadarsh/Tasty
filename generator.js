...
function transformModel(modelName) {
    ...
    // [Book] -> [Model]
    let modelNameSingularUpperCaseFirst = modelNameSingularLowerCase.charAt(0).toUpperCase() + modelNameSingularLowerCase.slice(1);
    // [Books]  -> [Models]
    let modelNamePluralUpperCaseFirst = modelNamePluralLowerCase.charAt(0).toUpperCase() + modelNamePluralLowerCase.slice(1);

    return { modelNameSingularLowerCase, modelNamePluralLowerCase, modelNameSingularUpperCaseFirst, modelNamePluralUpperCaseFirst };
}
...
function makeController(modelName) {
    ...
    let { modelNameSingularLowerCase, modelNamePluralLowerCase, modelNameSingularUpperCaseFirst, modelNamePluralUpperCaseFirst }
